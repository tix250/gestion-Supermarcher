...
<div class="container-fluid"> 
	...
	<?php 
		...
		<ul style="padding: 0 200px">
		 	 <li> <a href="<?php echo base_url();?>back_office/crud_categorie/delete_categorie/<?php echo($categorie[$i]['id_categorie']);?>">Supprimer la categorie <?php  echo($categorie[$i]['nom_categorie']); ?></a></li>
		</ul>
		<?php } ?>
 </div>
</div>
